...
def main():
    ...
    parser.add_argument("-r", type=str, default="RHF", help='reference')
    parser.add_argument("-c", type=int, default=0, help='charge')
    parser.add_argument("-m", type=int, default=1, help='multiplicity')
    ...
    psi4.core.set_global_option("REFERENCE", reference)
    psi4.core.set_global_option("D_CONVERGENCE", 1e-8)
    psi4.core.set_global_option("PUREAM", "True")
    psi4.core.set_output_file('output.dat', False)

    mol_str =  '%d %d\n' % (charge, mult) 
    mol_str += coors + 'symmetry ' + sym + '\n'
    mol_str += 'units Bohr\nno_reorient'
    if verbose > 0:
        print('-------------------')
        print(mol_str)
